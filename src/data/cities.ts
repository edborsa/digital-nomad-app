    ...
    touristAttractions: [
      {
        ...
        description: 'Uma das Sete Maravilhas do Mundo Moderno, a estátua do Cristo Redentor é um marco icônico que oferece vistas espetaculares da cidade.',
        cityId: 'rio-de-janeiro',
      },
      {
        id: 'rio2',
        name: 'Pão de Açúcar',
        description: 'Uma das montanhas mais famosas do Brasil, acessível por bondinho, oferecendo uma vista panorâmica impressionante do Rio de Janeiro.',
        cityId: 'rio-de-janeiro',
      },
      {
        id: 'rio3',
        name: 'Praia de Copacabana',
        description: 'Uma das praias mais famosas do mundo, conhecida por sua extensa faixa de areia, vida noturna animada e eventos culturais.',
        cityId: 'rio-de-janeiro',
      },
      {
        id: 'rio4',
        name: 'Jardim Botânico',
        description: 'Um dos maiores e mais antigos jardins botânicos do Brasil, repleto de flora tropical, trilhas e áreas de preservação.',
        cityId: 'rio-de-janeiro',
      },
    ],
    ...
    touristAttractions: [
      {
        id: 'bangkok1',
        name: 'Grande Palácio',
        description: 'Um dos marcos mais famosos de Bangkok, o Grande Palácio é um complexo de edifícios majestosos que serviu como residência dos reis da Tailândia.',
        cityId: 'bangkok',
      },
      {
        id: 'bangkok2',
        name: 'Templo do Buda de Esmeralda (Wat Phra Kaew)',
        description: 'Localizado dentro do Grande Palácio, este templo é considerado o mais sagrado da Tailândia e abriga a famosa estátua do Buda de Esmeralda.',
        cityId: 'bangkok',
      },
      {
        id: 'bangkok3',
        name: 'Mercado de Chatuchak',
        description: 'Um dos maiores mercados de rua do mundo, com mais de 8.000 barracas vendendo uma enorme variedade de produtos, de artesanato a roupas e comida.',
        cityId: 'bangkok',
      },
      {
        id: 'bangkok4',
        name: 'Wat Arun (Templo do Amanhecer)',
        description: 'Localizado às margens do rio Chao Phraya, Wat Arun é conhecido por sua torre central imponente e sua arquitetura intrincada.',
        cityId: 'bangkok',
      },
    ],
    ...
    touristAttractions: [
      {
        id: 'krabi1',
        name: 'Railay Beach',
        description: 'Uma das praias mais bonitas da Tailândia, famosa por suas falésias calcárias e paisagens de tirar o fôlego.',
        cityId: 'krabi',
      },
      {
        id: 'krabi2',
        name: 'Ilhas Phi Phi',
        description: 'Um arquipélago de tirar o fôlego, com praias paradisíacas e águas cristalinas, perfeito para mergulho.',
        cityId: 'krabi',
      },
      {
        id: 'krabi3',
        name: 'Templo da Caverna do Tigre',
        description: 'Um templo budista situado em uma montanha, acessível por uma longa escadaria, oferecendo vistas panorâmicas incríveis.',
        cityId: 'krabi',
      },
      {
        id: 'krabi4',
        name: 'Praia de Ao Nang',
        description: 'Uma das praias mais populares de Krabi, conhecida por sua beleza natural e uma ótima base para explorar as ilhas próximas.',
        cityId: 'krabi',
      },
    ],
    location: {
...

  {
    ...
    touristAttractions: [
      ...
      },
      {
        ...
        description: 'Um santuário natural e cultural, habitado por centenas de macacos, em meio a templos e florestas tropicais densas.',
        cityId: 'bali',
      },
      {
        id: 'bali3',
        name: 'Terraços de Arroz de Tegallalang',
        description: 'Uma das paisagens mais icônicas de Bali, com impressionantes terraços de arroz que proporcionam vistas espetaculares.',
        cityId: 'bali',
      },
      {
        id: 'bali4',
        name: 'Monte Batur',
        description: 'Um vulcão ativo que atrai caminhantes e aventureiros para subir até o topo e contemplar um incrível nascer do sol.',
        cityId: 'bali',
      },
    ],
    location: {
    ...
    touristAttractions: [
      {
        id: 'amsterdam1',
        name: 'Museu Van Gogh',
        description: 'Lar da maior coleção de obras de Vincent Van Gogh, este museu oferece uma viagem pela vida e trabalho do pintor.',
        cityId: 'amsterdam',
      },
      {
        id: 'amsterdam2',
        name: 'Casa de Anne Frank',
        description: 'Um museu no antigo esconderijo de Anne Frank durante a Segunda Guerra Mundial, oferecendo uma visão emocionante de sua história.',
        cityId: 'amsterdam',
      },
      {
        id: 'amsterdam3',
        name: 'Rijksmuseum',
        description: 'O museu nacional dos Países Baixos, abrigando uma vasta coleção de arte, história e cultura, incluindo obras-primas de Rembrandt.',
        cityId: 'amsterdam',
      },
      {
        id: 'amsterdam4',
        name: 'Vondelpark',
        description: 'O maior parque de Amsterdã, um lugar perfeito para caminhar, andar de bicicleta, relaxar e aproveitar o ar livre.',
        cityId: 'amsterdam',
      },
    ],
    location: {
    ...
    touristAttractions: [
      {
        id: 'cancun1',
        name: 'Chichén Itzá',
        description: 'Uma das Novas Sete Maravilhas do Mundo, este sítio arqueológico maia é uma das atrações mais visitadas perto de Cancún.',
        cityId: 'cancun',
      },
      {
        id: 'cancun2',
        name: 'Isla Mujeres',
        description: 'Uma pequena ilha a apenas 13 km de Cancún, famosa por suas praias tranquilas e excelente mergulho com snorkel.',
        cityId: 'cancun',
      },
      {
        id: 'cancun3',
        name: 'Xcaret Park',
        description: 'Um parque temático ecoarqueológico que oferece atividades ao ar livre, shows culturais e uma chance de conhecer a fauna local.',
        cityId: 'cancun',
      },
      {
        id: 'cancun4',
        name: 'Praia de Delfines',
        description: 'Uma das praias mais populares de Cancún, com vistas deslumbrantes do mar do Caribe e um local ideal para relaxar ao sol.',
        cityId: 'cancun',
      },
    ],
    location: {
    ...
    touristAttractions: [
      {
        id: 'dubai1',
        name: 'Burj Khalifa',
        description: 'O edifício mais alto do mundo, com 828 metros de altura, oferecendo vistas panorâmicas incríveis de Dubai do seu mirante.',
        cityId: 'dubai',
      },
      {
        id: 'dubai2',
        name: 'Dubai Mall',
        description: 'Um dos maiores centros comerciais do mundo, com mais de 1.200 lojas, restaurantes, um aquário e um parque temático interno.',
        cityId: 'dubai',
      },
      {
        id: 'dubai3',
        name: 'Ilha Palm Jumeirah',
        description: 'Uma ilha artificial em forma de palmeira, famosa por seus resorts de luxo, restaurantes, e vistas impressionantes da cidade.',
        cityId: 'dubai',
      },
      {
        id: 'dubai4',
        name: 'Deserto de Dubai',
        description: 'Aventure-se no deserto de Dubai com passeios de safári, dunas de areia e experiências culturais beduínas.',
        cityId: 'dubai',
      },
    ],
    location: {
    ...
    touristAttractions: [
      {
        id: 'cdmx1',
        name: 'Zócalo',
        description: 'A maior praça da cidade, rodeada por edifícios históricos, incluindo a Catedral Metropolitana e o Palácio Nacional.',
        cityId: 'ciudad-de-mexico',
      },
      {
        id: 'cdmx2',
        name: 'Museu Nacional de Antropologia',
        description: 'Um dos museus mais importantes do México, com uma vasta coleção de artefatos arqueológicos e etnográficos que celebram a cultura mexicana.',
        cityId: 'ciudad-de-mexico',
      },
      {
        id: 'cdmx3',
        name: 'Castelo de Chapultepec',
        description: 'Localizado no alto do bosque de Chapultepec, este castelo oferece uma visão única da história mexicana e vistas espetaculares da cidade.',
        cityId: 'ciudad-de-mexico',
      },
      {
        id: 'cdmx4',
        name: 'Coyoacán',
        description: 'Um bairro histórico e artístico, onde se encontra a Casa Azul, a antiga residência e agora museu da famosa pintora Frida Kahlo.',
        cityId: 'ciudad-de-mexico',
      },
    ],
    location: {
    ...
    touristAttractions: [
      {
        id: 'hk1',
        name: 'Victoria Peak',
        description: 'O ponto mais alto de Hong Kong, oferecendo vistas panorâmicas deslumbrantes do horizonte da cidade e do porto de Victoria.',
        cityId: 'hong-kong',
      },
      {
        id: 'hk2',
        name: 'Avenida das Estrelas',
        description: 'Uma caminhada ao longo do porto de Victoria, homenageando as estrelas do cinema de Hong Kong, com uma vista incrível da baía.',
        cityId: 'hong-kong',
      },
      {
        id: 'hk3',
        name: 'Big Buddha (Tian Tan Buddha)',
        description: 'Uma impressionante estátua de bronze do Buda, localizada na ilha de Lantau, acessível por teleférico.',
        cityId: 'hong-kong',
      },
      {
        id: 'hk4',
        name: 'Mercado Noturno de Temple Street',
        description: 'Um famoso mercado noturno onde turistas e moradores locais encontram comida de rua, roupas e itens tradicionais.',
        cityId: 'hong-kong',
      },
    ],
    location: {
    ...
    touristAttractions: [
      {
        ...
        description: 'A maior catedral da Eslováquia e um dos mais belos exemplos de arquitetura gótica na Europa Central.',
        cityId: 'kosice',
      },
      {
        id: 'kosice2',
        name: 'Rua Hlavná',
        description: 'A rua principal de Košice, repleta de edifícios históricos, restaurantes e cafés, sendo o coração da cidade.',
        cityId: 'kosice',
      },
      {
        id: 'kosice3',
      ...
      },
      {
        ...
        description: 'Um museu que oferece uma visão abrangente da história, arte e cultura da região leste da Eslováquia.',
        cityId: 'kosice',
      },
    ],
    location: {
    ...
    touristAttractions: [
      {
        ...
        description: 'Um dos principais marcos da cidade, Federation Square é um espaço público vibrante, cercado por museus, galerias e restaurantes.',
        cityId: 'melbourne',
      },
      {
        id: 'melbourne2',
        name: 'Jardins Botânicos Reais de Melbourne',
        description: 'Uma das áreas verdes mais importantes da cidade, oferecendo trilhas relaxantes e uma variedade de flora nativa.',
        cityId: 'melbourne',
      },
      {
        id: 'melbourne3',
        name: 'Crown Casino',
        description: 'Um dos maiores complexos de entretenimento da cidade, oferecendo cassinos, restaurantes e uma vista impressionante do rio Yarra.',
        cityId: 'melbourne',
      },
      {
        id: 'melbourne4',
        name: 'Queen Victoria Market',
        description: 'Um dos mercados mais antigos e famosos da Austrália, oferecendo uma ampla variedade de produtos frescos, artesanato e eventos culturais.',
        cityId: 'melbourne',
      },
    ],
    location: {
    ...
    touristAttractions: [
      {
        ...
        description: 'Um dos marcos mais icônicos de Singapura, conhecido por seu hotel de luxo, cassino e a famosa piscina de borda infinita no topo.',
        cityId: 'singapore',
      },
      {
        id: 'singapore2',
        name: 'Gardens by the Bay',
        description: "Jardins futuristas que apresentam as famosas 'Supertrees' e cúpulas de plantas que criam um espetáculo visual e tecnológico.",
        cityId: 'singapore',
      },
      {
        id: 'singapore3',
        name: 'Merlion Park',
        description: 'Um dos símbolos mais reconhecidos de Singapura, o parque abriga a famosa estátua de Merlion, metade peixe e metade leão.',
        cityId: 'singapore',
      },
      {
        id: 'singapore4',
        name: 'Chinatown',
        description: 'Um vibrante bairro que oferece uma imersão na cultura chinesa com templos, mercados e restaurantes tradicionais.',
        cityId: 'singapore',
      },
    ],
    location: {
